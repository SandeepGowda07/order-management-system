...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedProducts() {
        ...
        magazines.add(createProduct("National Geographic",
                "Explore the world through world-class photojournalism and storytelling.", 12.99, 50, "2024-01-01"));
        magazines.add(
                createProduct("Time", "The global magazine of news, analysis, and ideas.", 9.99, 100, "2024-02-15"));
        magazines
                .add(createProduct("Vogue", "The world's most influential fashion magazine.", 14.50, 75, "2024-03-01"));
        magazines.add(createProduct("The New Yorker", "In-depth reporting, cultural commentary, fiction, and humor.",
                8.99, 120, "2024-04-10"));
        magazines.add(
                createProduct("Forbes", "Business, investing, technology, entrepreneurship, leadership, and lifestyle.",
                        11.00, 60, "2024-01-20"));
        ...
        magazines.add(createProduct("Wired",
                "Where tomorrow is realized. Covering business, lifestyle, and innovation.", 7.99, 85, "2024-02-28"));
        ...
        magazines.add(
                createProduct("Fast Company", "Focusing on technology, business, and design.", 9.00, 70, "2024-03-22"));
        magazines.add(createProduct("Better Homes & Gardens", "Inspiration for your home and lifestyle.", 5.99, 200,
                "2023-11-30"));
        magazines.add(createProduct("People", "Celebrity news, human interest stories, and royal family updates.", 4.99,
                300, "2024-04-05"));
        ...
        magazines.add(createProduct("Men's Health", "The leading authority on men's fitness, health, and lifestyle.",
                7.50, 110, "2024-03-05"));
        magazines.add(createProduct("Smithsonian Magazine", "Deep dives into history, science, art, and culture.",
                11.99, 65, "2024-01-18"));
        magazines.add(createProduct("Esquire", "Style, fashion, politics, and culture for the modern man.", 8.50, 95,
                "2024-02-20"));
        magazines.add(createProduct("Food & Wine", "The definitive guide to culinary adventure and entertaining.", 6.25,
                130, "2024-03-12"));
